...
export const enTranslations: Translations = {
  ...
  input: {
    ...
    ctEnhancementRate: 'CT Enhancement Rate',
    enhancementRateHelper: 'Percentage of CT scans that are contrast-enhanced (0-100%)',
  ...
  results: {
    ...
    plainFee: 'CT Plain Scan Fee',
    feeReference: 'Based on National Radiology Fee Standards (August 2025 update, average of lowest and highest prices)',
    ...
    charts: {
      ...
      cumulativeSubtitle: '12-Month Cumulative Revenue Analysis',
      timeMonths: 'Time (Months)',
      cumulativeRevenue: 'Cumulative Revenue (¥)',
      cumulativeNote1: 'Chart shows cumulative revenue comparison between two devices over 12 months',
      cumulativeNote2: 'Target device revenue includes: base exam fees + contrast savings + additional exam revenue',
      cumulativeNote3: 'Hover over data points to view detailed monthly revenue breakdown',
